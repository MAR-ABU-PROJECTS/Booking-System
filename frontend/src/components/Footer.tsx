				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<p className="text-gray-300 leading-relaxed max-w-md font-light text-base">
							Nigeria&apos;s premier luxury accommodation
							provider, offering exceptional short-term rentals
							and premium properties across the nation&apos;s most
					...
					<div className="flex flex-col md:flex-row justify-between items-center gap-6">
						<div className="flex items-center gap-6">
							<p className="text-sm text-gray-400 font-light">
								© 2024 MAR ABU PROJECTS SERVICES LTD. All
								rights reserved.
							</p>
						</div>
						...
						<div className="flex items-center gap-4">
							...
							<div className="flex gap-3">
								<Link
									href="/"
									className="w-8 h-8 bg-gray-800 hover:bg-amber-600 rounded-full flex items-center justify-center transition-colors duration-300 group"
								>
