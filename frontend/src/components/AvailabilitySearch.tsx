		...
		<>
			<div className="relative -mt-32 z-20 px-4 mx-auto max-w-7xl">
				...
				>
					...
					<div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-amber-500/5 pointer-events-none"></div>
					...
					<div className="relative z-10 text-center mb-8">
						...
						>
							Discover luxury accommodations tailored to your
							preferences
						</motion.p>
					</div>
