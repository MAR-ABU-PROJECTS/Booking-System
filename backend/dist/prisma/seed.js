...
async function main() {
    ...
    console.log(`✅ Admin created/updated: ${superAdmin4.email} - Role: ${superAdmin4.role}`);
    ...
    const properties = [
        ...
        },
        {
            ...
            description: "Where luxury, smart living, and minimalist elegance meet. Located in the heart of Lekki, this ultra-spacious 2-bedroom shortlet is designed for those who crave comfort and sophistication.\n\n• Fully equipped kitchen with washing machine, refrigerator, microwave, and oven\n• Elegant outer lounge area for relaxation\n• Private swimming pool\n• Spacious dining area for entertaining\n• Stunning balcony with city views\n• Minimalist, high-end interiors",
