...
class PropertyService {
     ...
     */
    createProperty(hostId, propertyData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Log audit
                yield this.logAudit(hostId, "CREATE", "Property", property.id, {
     ...
     * Get property by ID
     */
    getPropertyById(propertyId_1) {
        return __awaiter(this, arguments, void 0, function* (propertyId, includeUnavailable = false) {
            ...
            const averageRating = property.reviews.length > 0
                ...
                : 0;
            const { reviews } = property, propertyWithoutReviews = __rest(property, ["reviews"]);
            return Object.assign(Object.assign({}, propertyWithoutReviews), { averageRating: Number(averageRating.toFixed(1)), reviewCount: reviews.length });
        });
    }
    /**
     * Update property
     */
    updateProperty(propertyId, hostId, updateData, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate input
                ...
                // Log audit
                yield this.logAudit(hostId, "UPDATE", "Property", propertyId, validatedData);
     ...
     * Delete property
     */
    deleteProperty(propertyId, hostId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check ownership or admin permissions
            const existingProperty = yield prisma.property.findUnique({
                where: { id: propertyId },
            ...
            const activeBookings = yield prisma.booking.count({
                where: {
                    propertyId,
                    status: {
            ...
            // Log audit
            yield this.logAudit(hostId, "DELETE", "Property", propertyId, {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const processedProperties = properties.map((property) => {
                    const { reviews } = property, propertyData = __rest(property, ["reviews"]);
                    const averageRating = reviews.length > 0
                        ? reviews.reduce((sum, review) => sum + review.rating, 0) /
                            reviews.length
                        : 0;
                    return Object.assign(Object.assign({}, propertyData), { averageRating: Number(averageRating.toFixed(1)), reviewCount: reviews.length });
                });
                return {
     ...
     */
    getPropertiesByHost(hostId_1) {
        return __awaiter(this, arguments, void 0, function* (hostId, includeInactive = false) {
     ...
     */
    updateAvailability(propertyId, hostId, availabilityData, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate input
                ...
                yield prisma.$transaction(dates.map((date) => prisma.propertyAvailability.upsert({
                    where: {
                        propertyId_date: {
                            propertyId,
                            date,
                ...
                // Log audit
                yield this.logAudit(hostId, "UPDATE", "PropertyAvailability", propertyId, {
    ...
    checkAvailability(propertyId, checkIn, checkOut) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const unavailableDates = yield prisma.propertyAvailability.findMany({
                where: {
                    propertyId,
            ...
            const specialPricing = yield prisma.propertyAvailability.findMany({
                where: {
                    propertyId,
                    date: { gte: checkInDate, lt: checkOutDate },
                    price: { not: null },
            ...
            for (const date of dates) {
                ...
                totalPrice += (specialPrice === null || specialPrice === void 0 ? void 0 : specialPrice.price) || property.baseRate;
            }
            return {
                available: true,
                price: totalPrice,
     ...
     */
    getPropertyAnalytics(propertyId, hostId, userRole, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check ownership
            const property = yield prisma.property.findUnique({
                where: { id: propertyId },
            ...
            const [bookingStats, revenueStats, reviewStats] = yield Promise.all([
                // Booking statistics
                ...
                prisma.review.aggregate({
                    where: Object.assign({ propertyId, approved: true }, (Object.keys(dateFilter).length > 0 && { createdAt: dateFilter })),
                    _count: { id: true },
                    _avg: { rating: true },
                }),
            ]);
