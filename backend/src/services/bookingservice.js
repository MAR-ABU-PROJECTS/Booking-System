...
class BookingService {
     ...
     */
    calculatePricing(propertyId_1, checkIn_1, checkOut_1) {
        return __awaiter(this, arguments, void 0, function* (propertyId, checkIn, checkOut, adults = 1) {
            ...
            // Check availability
            const availability = yield this.checkAvailability(propertyId, checkIn, checkOut);
            ...
            for (let date = new Date(checkInDate); date < checkOutDate; date.setDate(date.getDate() + 1)) {
                ...
                const specialPricing = yield prisma.propertyAvailability.findUnique({
                    where: {
                        propertyId_date: {
                            propertyId,
                            date: new Date(date),
                ...
                let dailyRate = (specialPricing === null || specialPricing === void 0 ? void 0 : specialPricing.price) || property.baseRate;
                if (isWeekend && !(specialPricing === null || specialPricing === void 0 ? void 0 : specialPricing.price)) {
     ...
     */
    createBooking(customerId, bookingData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Log audit
                yield this.logAudit(customerId, "CREATE", "Booking", booking.id, {
                    bookingNumber: booking.bookingCode,
                    propertyName: booking.property.name,
                    totalAmount: booking.total,
                });
                // Send notifications (implement notification service)
                yield this.sendBookingNotifications(booking, "CREATED");
                return booking;
            }
            catch (error) {
     ...
     * Get booking by ID
     */
    getBookingById(bookingId, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    searchBookings(searchParams, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate input
                ...
                // Execute queries
                const [bookings, total, summary] = yield Promise.all([
     ...
     * Update booking
     */
    updateBooking(bookingId, updateData, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate input
                ...
                if (validatedData.checkIn ||
                    ...
                    const pricing = yield this.calculatePricing(existingBooking.propertyId, checkIn, checkOut, adults);
                    const nights = Math.ceil((new Date(checkOut).getTime() - new Date(checkIn).getTime()) /
                        (1000 * 60 * 60 * 24));
                    pricingUpdate = {
                        nights,
                ...
                const updatedBooking = yield prisma.booking.update({
                    where: { id: bookingId },
                    data: Object.assign(Object.assign(Object.assign(Object.assign({}, validatedData), (validatedData.checkIn && {
                ...
                // Log audit
                yield this.logAudit(userId, "UPDATE", "Booking", bookingId, validatedData);
     ...
     */
    performBookingAction(bookingId, actionData, userId, userRole) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validate input
                const validatedAction = exports.bookingActionSchema.parse(actionData);
                // Get booking
                const booking = yield this.getBookingById(bookingId);
                if (!booking) {
                    throw new Error("Booking not found");
                }
                // Check permissions
                ...
                // Log audit
                yield this.logAudit(userId, "UPDATE", "Booking", bookingId, {
                    action: validatedAction.action,
                    reason: validatedAction.reason,
                    newStatus: updateData.status,
                });
                // Send notifications
                yield this.sendBookingNotifications(updatedBooking, validatedAction.action.toUpperCase());
                return updatedBooking;
            }
            catch (error) {
                if (error instanceof zod_1.z.ZodError) {
    ...
    generateBookingNumber() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const latestBooking = yield prisma.booking.findFirst({
                where: {
                    bookingCode: {
     ...
     */
    getBookingSummary(whereClause) {
        return __awaiter(this, void 0, void 0, function* () {
            const [revenueResult, statusCounts] = yield Promise.all([
     ...
     */
    sendBookingNotifications(booking, eventType) {
        return __awaiter(this, void 0, void 0, function* () {
