...
class EmailService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield resend.emails.send({
                    ...
                    html: options.html,
                    attachments: (_a = options.attachments) === null || _a === void 0 ? void 0 : _a.map((att) => {
                        if (!att.content) {
                ...
                logger_middleware_1.logger.info("Email sent successfully", {
                    to: options.to,
                    messageId: (_b = response === null || response === void 0 ? void 0 : response.data) === null || _b === void 0 ? void 0 : _b.id,
                });
                return true;
            }
            catch (error) {
     ...
     */
    sendReceiptUploadedNotification(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendReceiptVerifiedNotification(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendBookingApprovedEmail(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendBookingCancelledEmail(email, booking, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendPropertyApprovedEmail(email, property) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendPropertyRejectedEmail(email, property, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendReviewRequestEmail(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendHostBookingNotification(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendPaymentReminderEmail(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendCheckInReminderEmail(email, booking) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
     ...
     */
    sendReviewStatusUpdate(email, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const content = `
