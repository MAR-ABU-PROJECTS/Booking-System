...
class AuthService {
     ...
     * Register new user
     */
    register(userData, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Hash password
                const hashedPassword = yield bcryptjs_1.default.hash(validatedData.password, 12);
                // Create user
                ...
                // Log audit
                yield this.logAudit(user.id, "CREATE", "User", user.id, {
                    ipAddress,
                    userAgent,
    ...
    login(email, password, ipAddress, userAgent) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Verify password
                const isPasswordValid = yield bcryptjs_1.default.compare(validatedCredentials.password, user.password);
                if (!isPasswordValid) {
                    throw new Error("Invalid email or password");
                }
                ...
                // Log audit
                yield this.logAudit(user.id, "LOGIN", "User", user.id, {
                    ipAddress,
                    userAgent,
                    loginTime: new Date(),
                });
                ...
                const tokens = yield this.generateTokens(userWithoutPassword);
                return tokens;
            }
            catch (error) {
                if (error instanceof zod_1.z.ZodError) {
    ...
    refreshToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.generateTokens(user);
            }
            catch (error) {
    ...
    changePassword(userId, currentPassword, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isCurrentPasswordValid = yield bcryptjs_1.default.compare(validatedData.currentPassword, user.password);
                if (!isCurrentPasswordValid) {
                    throw new Error("Current password is incorrect");
                }
                // Hash new password
                const hashedNewPassword = yield bcryptjs_1.default.hash(validatedData.newPassword, 12);
                // Update password
                yield prisma.user.update({
                    where: { id: userId },
                ...
                // Log audit
                yield this.logAudit(userId, "UPDATE", "User", userId, {
    ...
    forgotPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Log audit
                yield this.logAudit(user.id, "UPDATE", "User", user.id, {
    ...
    logout(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.logAudit(userId, "LOGOUT", "User", userId, {
                logoutTime: new Date(),
            });
        });
    }
...
function requireAuth(options) {
    return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Get user data
            const user = yield exports.authService.getUserById(payload.userId);
            if (!user) {
                return res.status(401).json({
                    success: false,
            ...
            if (options === null || options === void 0 ? void 0 : options.allowPending) {
                allowedStatuses.push(client_1.UserStatus.PENDING_VERIFICATION);
            }
            if ((options === null || options === void 0 ? void 0 : options.role) && !exports.authService.hasPermission(user.role, options.role)) {
