 ...
 * @access  Protected
 */
router.get('/profile', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @access  Protected
 */
router.post('/avatar', (0, authservice_1.requireAuth)(), upload.single('avatar'), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.file) {
        throw new error_middleware_2.AppError('Avatar image is required', 400);
    }
    // Delete old avatar if exists
    const currentUser = yield server_1.prisma.user.findUnique({
        where: { id: req.user.id },
        select: { avatar: true },
    });
 ...
 * @access  Protected
 */
router.delete('/avatar', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield server_1.prisma.user.findUnique({
        where: { id: req.user.id },
        select: { avatar: true },
    });
...
router.put('/password', (0, authservice_1.requireAuth)(), [
    ...
    yield emailservice_1.emailService.sendPasswordChangeNotification(user.email);
 ...
 * @access  Protected
 */
router.get('/dashboard', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user.id;
    const userRole = req.user.role;
    if (userRole === client_1.UserRole.CUSTOMER) {
        // Customer dashboard
        const [bookings, upcomingBookings, reviews, favoriteProperties] = yield Promise.all([
        ...
        const [properties, bookings, earnings, reviews] = yield Promise.all([
 ...
 * @access  Protected
 */
router.post('/favorites/:propertyId', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existing = yield server_1.prisma.favorite.findUnique({
        where: {
            userId_propertyId: {
                userId: req.user.id,
                propertyId,
    ...
    // Add to favorites
    yield server_1.prisma.favorite.create({
        data: {
            userId: req.user.id,
            propertyId,
        },
 ...
 * @access  Protected
 */
router.delete('/favorites/:propertyId', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { propertyId } = req.params;
    yield server_1.prisma.favorite.delete({
        where: {
            userId_propertyId: {
                userId: req.user.id,
                propertyId,
 ...
 * @access  Protected
 */
router.get('/favorites', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const favoritesWithRatings = favorites.map(fav => {
        ...
        const averageRating = ratings.length > 0
            ...
            : 0;
        return Object.assign(Object.assign({}, fav), { property: Object.assign(Object.assign({}, fav.property), { averageRating: Math.round(averageRating * 10) / 10, reviewCount: ratings.length, reviews: undefined }) });
    });
    res.json({
        success: true,
        data: {
...
router.delete('/account', (0, authservice_1.requireAuth)(), [
    ...
    const activeBookings = yield server_1.prisma.booking.count({
        where: {
    ...
    yield emailservice_1.emailService.sendAccountDeletionConfirmation(user.email, `${user.firstName} ${user.lastName}`);
