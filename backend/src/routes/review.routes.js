 ...
 * @access  Public
 */
router.get('/', (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/:id', (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/', (0, authservice_1.requireAuth)(), [
    ...
    if (((_a = booking.review) === null || _a === void 0 ? void 0 : _a.comment) && booking.review.comment.length > 0) {
    ...
    yield emailservice_1.emailService.sendReviewRequestEmail(booking.property.host.email, {
...
router.put("/:id/approve", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), [
    ...
    yield emailservice_1.emailService.sendReviewStatusUpdate(review.customer.email, {
 ...
 * @access  Admin only
 */
router.get("/pending", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @access  Public
 */
router.get('/property/:propertyId/stats', (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { propertyId } = req.params;
    const [reviews, ratingDistribution] = yield Promise.all([
        server_1.prisma.review.findMany({
            where: {
                propertyId,
                approved: true,
