...
router.post('/', (0, authservice_1.requireAuth)(), fileservice_1.uploadMiddleware.receipt, [
    ...
    const receipt = yield server_1.prisma.receipt.create({
        data: {
...
router.get('/:id', (0, authservice_1.requireAuth)(), [(0, express_validator_1.param)('id').isString()], validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const receipt = yield server_1.prisma.receipt.findUnique({
