 ...
 */
router.get("/", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield server_1.prisma.booking.count({ where: whereClause });
    res.json({
        status: "success",
 ...
 */
router.post("/", (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Create booking
        const booking = yield server_1.prisma.booking.create({
            data: {
                bookingCode,
...
router.patch("/:id/status", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), [
    ...
    // Update booking
    const updated = yield server_1.prisma.booking.update({
        where: { id: req.params.id },
        data: {
            status,
            adminNotes: reason,
    ...
    yield emailservice_1.emailService.sendBookingConfirmation(booking.customer.email, {
 ...
 *         description: Booking not found
 */
router.post("/:id/cancel", (0, authservice_1.requireAuth)(), [(0, express_validator_1.param)("id").isString(), (0, express_validator_1.body)("reason").optional().isString()], validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (booking.customerId !== req.user.id) {
        throw new error_middleware_2.AppError("Not authorized to cancel this booking", 403);
    }
    // Can only cancel pending or approved bookings
    if (![client_1.BookingStatus.PENDING, client_1.BookingStatus.APPROVED].includes(booking.status)) {
    ...
    yield emailservice_1.emailService.sendBookingCancelledEmail(booking.property.host.email, {
    ...
    (0, logger_middleware_1.auditLog)("BOOKING_CANCELLED", req.user.id, {
        bookingId: req.params.id,
        reason,
    }, req.ip);
    res.json({
 ...
 *         description: Booking not found
 */
router.get("/:id/invoice", (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const booking = yield server_1.prisma.booking.findUnique({
        where: { id: req.params.id },
        include: {
            property: {
