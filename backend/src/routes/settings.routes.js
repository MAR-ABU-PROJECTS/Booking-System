 ...
 * @access  Admin only
 */
router.get('/system', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield server_1.prisma.setting.findMany({
 ...
 */
router.put('/system', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
    ...
    (0, express_validator_1.body)('settings.*.type').optional().isIn(['string', 'number', 'boolean', 'json']),
    ...
    for (const setting of settings) {
        ...
        if (type === 'number') {
            ...
            if (isNaN(processedValue)) {
                throw new error_middleware_2.AppError(`Invalid number value for setting ${key}`, 400);
            }
        }
            ...
            try {
                ...
                throw new error_middleware_2.AppError(`Invalid JSON value for setting ${key}`, 400);
            }
        }
        // Update or create setting
        const updated = yield server_1.prisma.setting.upsert({
            where: { key },
            update: {
 ...
 * @access  Public
 */
router.get('/public', (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const publicSettings = yield server_1.prisma.setting.findMany({
        where: { isPublic: true },
        select: {
            key: true,
            value: true,
 ...
 * @access  Admin only
 */
router.get('/booking', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const bookingSettings = yield server_1.prisma.setting.findMany({
    ...
    const defaultSettings = Object.assign({ defaultServiceFeePercentage: 10, maxAdvanceBookingDays: 365, minAdvanceBookingHours: 24, cancellationGracePeriodHours: 24, autoApprovalEnabled: false, instantBookingEnabled: true, requireHostApproval: true, maxGuestsPerBooking: 16 }, settings);
    res.json({
        success: true,
 ...
 * @access  Admin only
 */
router.put('/booking', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
 ...
 * @access  Admin only
 */
router.get('/payment', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paymentSettings = yield server_1.prisma.setting.findMany({
 ...
 * @access  Super Admin only
 */
router.put('/payment', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
 ...
 * @access  Admin only
 */
router.get('/email', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const emailSettings = yield server_1.prisma.setting.findMany({
 ...
 * @access  Super Admin only
 */
router.put('/email', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
 ...
 * @access  Admin only
 */
router.post('/email/test', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
    (0, express_validator_1.body)('email').isEmail().withMessage('Valid email address required'),
], validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    try {
        yield emailservice_1.emailService.sendTestEmail(email, {
 ...
 * @access  Admin only
 */
router.get('/company', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const companySettings = yield server_1.prisma.setting.findMany({
    ...
    // Set defaults
    const defaultSettings = Object.assign({ companyName: 'MAR Abu Projects Services LLC', companyEmail: 'info@marabuprojects.com', companyPhone: '+234-XXX-XXX-XXXX', companyAddress: 'Nigeria', companyWebsite: 'https://marabuprojects.com', supportEmail: 'support@marabuprojects.com', termsUrl: '/terms', privacyUrl: '/privacy', aboutUrl: '/about' }, settings);
    res.json({
        success: true,
        data: defaultSettings,
    });
 ...
 * @access  Admin only
 */
router.put('/company', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
 ...
 * @access  Super Admin only
 */
router.post('/maintenance', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), [
    ...
    yield Promise.all([
        server_1.prisma.setting.upsert({
        ...
        message && server_1.prisma.setting.upsert({
        ...
        estimatedEnd && server_1.prisma.setting.upsert({
 ...
 * @access  Super Admin only
 */
router.get('/backup', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Get backup-related settings
    const backupSettings = yield server_1.prisma.setting.findMany({
    ...
    const backupStatus = Object.assign({ lastBackup: '2024-01-15T10:30:00Z', nextScheduled: '2024-01-16T10:30:00Z', status: 'healthy', size: '2.4GB', location: 'AWS S3' }, settings);
    res.json({
        success: true,
        data: backupStatus,
    });
