 ...
 * @access  Public
 */
router.get('/', (0, authservice_1.optionalAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const propertiesWithRatings = properties.map(property => {
        ...
        const averageRating = ratings.length > 0
            ...
            : 0;
        return Object.assign(Object.assign({}, property), { averageRating: Math.round(averageRating * 10) / 10, reviewCount: property._count.reviews, bookingCount: property._count.bookings, reviews: undefined });
    });
 ...
 * @access  Public
 */
router.get('/:id', (0, authservice_1.optionalAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const responseData = Object.assign(Object.assign({}, property), { averageRating: Math.round(averageRating * 10) / 10, reviewCount: property.reviews.length, unavailableDates, hostPropertyCount: property.host._count.hostedProperties });
    res.json({
        success: true,
        data: responseData,
    });
...
router.get('/:id/availability', [
    ...
    const overlappingBookings = yield server_1.prisma.booking.count({
        where: {
 ...
 */
router.get("/my-properties", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), [
    ...
    const propertyData = Object.assign(Object.assign({}, req.body), { hostId: req.user.id, status: client_1.PropertyStatus.PENDING });
    const property = yield server_1.prisma.property.create({
        data: propertyData,
        include: {
            host: {
                select: {
...
router.put("/:id", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), [
    ...
    const updatedProperty = yield server_1.prisma.property.update({
        where: { id: req.params.id },
        data: req.body,
    });
 ...
 * @access  Property Host (owner), Admin
 */
router.delete("/:id", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const property = yield server_1.prisma.property.findUnique({
        where: { id: req.params.id },
        include: {
            bookings: {
    ...
    yield server_1.prisma.property.delete({
        where: { id: req.params.id },
    });
 ...
 * @access  Property Host (owner), Admin
 */
router.get("/:id/bookings", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const property = yield server_1.prisma.property.findUnique({
        where: { id: req.params.id },
    });
    if (!property) {
