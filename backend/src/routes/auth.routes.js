 ...
 *         description: Server error
 */
router.post("/refresh", [(0, express_validator_1.body)("refreshToken").notEmpty().withMessage("Refresh token required")], validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { refreshToken } = req.body;
    try {
        const payload = authservice_1.authService.verifyToken(refreshToken);
        const user = yield authservice_1.authService.getUserById(payload.userId);
        if (!user) {
 ...
 *         description: Server error
 */
router.post("/verify-email", (0, authservice_1.requireAuth)({ allowPending: true }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield authservice_1.authService.verifyEmail(req.user.id);
 ...
 *         description: Server error
 */
router.post("/logout", (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield authservice_1.authService.logout(req.user.id);
 ...
 *         description: Server error
 */
router.get("/me", (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.json({
        success: true,
        data: req.user,
    });
...
router.put("/profile", (0, authservice_1.requireAuth)(), [
    ...
    const updatedUser = yield authservice_1.authService.updateProfile(req.user.id, req.body);
