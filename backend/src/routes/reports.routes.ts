...
//       ).length;
//       const cancelledBookings = property.bookings.filter(
...
//         0
//       );
//       const totalGuests = property.bookings.reduce(
...
//           totalGuests,
//           avgGuestsPerBooking:
//             totalBookings > 0 ? totalGuests / totalBookings : 0,
...
//       const scoreA =
//         a.metrics.totalRevenue * 0.7 + a.metrics.avgRating * 1000 * 0.3;
//       const scoreB =
...
//           0
//         ),
//         totalBookings: performanceData.reduce(
//           (sum, p) => sum + p.metrics.totalBookings,
//           0
//         ),
//         avgOccupancyRate:
//           performanceData.length > 0
//             ? performanceData.reduce(
//                 (sum, p) => sum + p.metrics.occupancyRate,
//                 0
...
//         returningCustomers: filteredData.filter(
//           (c) => c.segment === "returning"
//         ).length,
//         vipCustomers: filteredData.filter((c) => c.segment === "vip").length,
//         totalRevenue: filteredData.reduce(
//           (sum, c) => sum + c.metrics.totalSpent,
//           0
//         ),
//         avgCustomerValue:
