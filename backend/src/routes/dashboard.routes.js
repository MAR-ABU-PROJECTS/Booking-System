...
router.get('/customer', (0, authservice_1.requireAuth)(client_1.UserRole.CUSTOMER), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const avgRatingFavorites = favoriteProperties.map(fav => {
        ...
        return Object.assign(Object.assign({}, fav), { property: Object.assign(Object.assign({}, fav.property), { averageRating: ratings.length > 0
    ...
    const bookingStats = yield server_1.prisma.booking.groupBy({
        by: ['status'],
        where: { customerId: userId },
        _count: { status: true },
    });
    ...
    res.json({
        ...
        data: {
            overview: {
                ...
                memberSince: memberSince === null || memberSince === void 0 ? void 0 : memberSince.createdAt,
            },
...
router.get('/host', (0, authservice_1.requireAuth)(client_1.UserRole.ADMIN), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const propertiesWithStats = properties.map(property => {
        ...
        const averageRating = ratings.length > 0
            ? ratings.reduce((sum, rating) => sum + rating, 0) / ratings.length
            : 0;
        return Object.assign(Object.assign({}, property), { averageRating: Math.round(averageRating * 10) / 10, monthlyBookings: property._count.bookings, totalReviews: property._count.reviews, reviews: undefined });
    });
    ...
    const revenueHistory = yield server_1.prisma.$queryRaw `
      SELECT 
 ...
 * @access  Protected
 */
router.get('/quick-actions', (0, authservice_1.requireAuth)(), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const actions = [];
    switch (req.user.role) {
        case client_1.UserRole.CUSTOMER:
            // Customer quick actions
            const upcomingBookings = yield server_1.prisma.booking.count({
                where: {
            ...
            const pendingReviews = yield server_1.prisma.booking.count({
                where: {
                    customerId: req.user.id,
                    status: client_1.BookingStatus.COMPLETED,
                    review: { none: {} },
        ...
        case client_1.UserRole.ADMIN:
            // Host quick actions
            const pendingBookings = yield server_1.prisma.booking.count({
                where: {
                    property: { hostId: req.user.id },
                    status: client_1.BookingStatus.PENDING,
                },
            });
            const checkInsToday = yield server_1.prisma.booking.count({
                where: {
                    property: { hostId: req.user.id },
                    status: client_1.BookingStatus.APPROVED,
                    checkInDate: {
        ...
        case client_1.UserRole.ADMIN:
            // Admin quick actions
            const pendingApprovals = yield Promise.all([
