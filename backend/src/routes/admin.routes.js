 ...
 *                       example: 10
 */
router.get("/dashboard", (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Get date range (default last 30 days)
    const endDate = new Date();
    const startDate = new Date(endDate.getTime() - 30 * 24 * 60 * 60 * 1000);
    const [userStats, propertyStats, bookingStats, revenueStats, recentBookings, pendingReviews,] = yield Promise.all([
        // User statistics
 ...
 *                       - DELETED
 */
router.get("/users", (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get("/users/:id", (0, express_validator_1.param)("id").isString(), validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 *                   example: User not found
 */
router.delete("/users/:id", (0, express_validator_1.param)("id").isString(), validate, (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get("/properties", (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.put("/properties/:id/status", [
    ...
    const property = yield server_1.prisma.property.update({
        where: { id: req.params.id },
        data: {
            status,
            adminNotes: reason,
 ...
 */
router.get("/bookings", (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 *         description: Server error
 */
router.get("/settings", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), (0, error_middleware_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield server_1.prisma.systemSetting.findMany({
        orderBy: { key: "asc" },
    });
    res.json({
        success: true,
...
router.put("/settings", (0, authservice_1.requireAuth)({ role: client_1.UserRole.ADMIN }), [
    ...
    yield Promise.all(settings.map((setting) => server_1.prisma.systemSetting.upsert({
