    ...
    <section className="py-8 px-4 mx-auto max-w-7xl">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900">
          {properties.length} properties in Nigeria
        </h2>
        ...
        <div className="fixed inset-0 z-40 bg-white">
          <div className="h-full flex items-center justify-center bg-gray-100">
            <div className="text-center">
              <p className="text-xl font-medium text-gray-700 mb-4">Map View</p>
              <button
        ...
        <div className="fixed inset-0 z-40 bg-black/50 backdrop-blur-sm flex items-center justify-center">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Rooms and beds</label>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["Apartment", "Villa", "Penthouse", "Mansion"].map((type) => (
                    <button 
                      key={type} 
